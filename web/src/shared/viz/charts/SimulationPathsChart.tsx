 ...
 * paths a legend entry each would be noise, not information). `revealCount`
 * truncates every path to its first N points, which is what the caller
 * uses to animate "the simulation drawing itself" client-side (see
