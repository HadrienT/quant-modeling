		...
		<>
			<section className="hero">
				<div>
					...
					<p>
						Pick the instrument, configure its terms, and price through the API.
						Options, futures, and bonds are available with curve-based
						discounting.
					</p>
				</div>
			</section>
			...
			<section className="price-grid">
								...
								{p.instrument === "option" && (
									<>
										<label className="field">
											Option type
											<select
												value={p.isCall ? "call" : "put"}
												onChange={(e) => p.setIsCall(e.target.value === "call")}
											>
								...
								<label className="field">
									...
									<select
										...
										onChange={(e) => {
											...
											if (isEnabled(STRUCTURED_PRODUCTS, v))
												p.setStructuredProduct(v);
										}}
									>
								...
								<label className="field">
									...
									<select
										...
										onChange={(e) => {
											...
											if (isEnabled(COMMODITY_PRODUCTS, v))
												p.setCommodityProduct(v);
										}}
									>
				...
				<ResultsPanel
					...
					loading={p.loading}
					category={p.category}
					formatWithError={p.formatWithError}
				/>
			</section>
		</>
	);
