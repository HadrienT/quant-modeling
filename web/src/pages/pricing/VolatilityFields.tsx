...
export default function VolatilityFields(props: Props) {
	...
	const isSingle =
		volProduct === "variance-swap" || volProduct === "volatility-swap";
	const isAnalytic =
		volProduct === "variance-swap" && varSwapEngine === "analytic";
		...
		<>
				...
				<>
					<label className="field">
						...
						<input
							...
							step="0.001"
							value={strikeVar}
							onChange={(e) => setStrikeVar(Number(e.target.value))}
						/>
					...
					<label className="field">
						...
						<select
							value={varSwapEngine}
							onChange={(e) =>
								setVarSwapEngine(e.target.value as "analytic" | "mc")
							}
						>
			...
			{volProduct === "volatility-swap" && (
				<label className="field">
					...
					<input
						...
						step="0.01"
						value={strikeVol}
						onChange={(e) => setStrikeVol(Number(e.target.value))}
					/>
			...
			{volProduct === "dispersion-swap" && (
				<>
					...
					<label className="field span-2">
						...
						<input
							type="text"
							value={dispersionSpots}
							onChange={(e) => setDispersionSpots(e.target.value)}
						/>
					</label>
					<label className="field span-2">
						...
						<input
							type="text"
							value={dispersionVols}
							onChange={(e) => setDispersionVols(e.target.value)}
						/>
					</label>
					<label className="field span-2">
						...
						<input
							type="text"
							value={dispersionDividends}
							onChange={(e) => setDispersionDividends(e.target.value)}
						/>
					</label>
					<label className="field span-2">
						...
						<input
							type="text"
							value={dispersionWeights}
							onChange={(e) => setDispersionWeights(e.target.value)}
						/>
					...
					<label className="field">
						...
						<input
							...
							step="0.01"
							value={strikeSpread}
							onChange={(e) => setStrikeSpread(Number(e.target.value))}
						/>
					</label>
				</>
			)}
			...
			<label className="field span-2">
				...
				<input
					type="text"
					value={volObsDates}
					onChange={(e) => setVolObsDates(e.target.value)}
				/>
			</label>
