...
export default function OptionFields(props: Props) {
	...
	return (
		<>
				...
				<>
					...
					<label className="field">
						...
						<select
							value={averageType}
							onChange={(e) =>
								setAverageType(e.target.value as typeof averageType)
							}
						>
			...
			{product === "vanilla" &&
				(engine === "binomial" || engine === "trinomial") && (
					<label className="field">
						Tree steps
						<input
							type="number"
							step="10"
							value={treeSteps}
							onChange={(e) => setTreeSteps(Number(e.target.value))}
						/>
					</label>
				)}
				...
				<>
					<label className="field">
						...
						<input
							...
							step="10"
							value={pdeSpaceSteps}
							onChange={(e) => setPdeSpaceSteps(Number(e.target.value))}
						/>
					</label>
					<label className="field">
						PDE time steps
						<input
							...
							step="10"
							value={pdeTimeSteps}
							onChange={(e) => setPdeTimeSteps(Number(e.target.value))}
						/>
					</label>
				</>
			)}
