...
export const PRODUCT_CATALOG: ProductDef[] = [
	...
	},
	{
		...
		params: [
			...
			},
			{
				...
				options: [
					{ label: "Cash-or-Nothing", value: "cash-or-nothing" },
					{ label: "Asset-or-Nothing", value: "asset-or-nothing" },
				],
			},
			{
				key: "cash_amount",
	...
	},
	{
		...
		params: [
			...
			},
			{
				...
				options: [
					{ label: "Fixed Strike", value: "fixed-strike" },
					{ label: "Floating Strike", value: "floating-strike" },
				],
			},
			{
				key: "extremum",
	...
	},
	{
		...
		params: [
			{
				key: "spots",
				label: "Spots (comma-sep)",
				type: "number[]",
				default: [100, 100],
			},
			{
				key: "vols",
				label: "Vols (comma-sep)",
				type: "number[]",
				default: [0.2, 0.2],
			},
	...
	// ── Structured ───────────────────────────────────────
	{
		...
		params: [
			...
			{
				key: "observation_dates",
				label: "Obs dates (y)",
				type: "number[]",
				default: [0.25, 0.5, 0.75, 1.0],
			},
			{
				key: "autocall_barrier",
	...
	{
		type: "dispersion-swap",
		category: "volatility",
		label: "Dispersion Swap",
		params: [
			{
				key: "spots",
				label: "Spots (comma-sep)",
